                ...
                <div class="card-body">
                    ...
                    <form class="form-sample FormularioAjax" action="<?php echo SERVERURL; ?>ajax/facturaAjax.php" method="POST" data-form="update" autocomplete="off">
                        <div class="form-group row">
                            <input type="hidden" id="factura_cancelada_id_update" name="factura_cancelada_id_update" value="<?php echo $pagina[1]; ?>">
                            <label class="col-sm-4 col-form-label">&nbsp; Fecha de Creación</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control d-inp-light" id="fecha_upC" name="fecha_upC" maxlength="10" required="" data-toggle="datepicker" value="<?php echo $campos['fecha']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">&nbsp; Nombre del Cliente</label>
                            <div class="col-sm-8">
                                <select class="custom-select custom-select-sm form-control form-control d-inp-light" name="id_cliente_upC" id="id_cliente_upC">
                            ...
                            <input type="hidden" id="id_usuario_upC" name="id_usuario_upC" value="<?php echo $_SESSION['id_rol_lmr']; ?>">
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">&nbsp; Estado del Pago</label>
                            <div class="col-sm-8">
                                <select class="custom-select custom-select-sm form-control form-control d-inp-light" name="estado_pago_upC" id="estado_pago_upC">
                                    <?php
                        ...
                        <hr />
                        <div class="form-group row">
                            <input type="hidden" id="id_detalle_cancelado_update" name="id_detalle_cancelado_update" value="<?php echo $campos['id_detalle_factura']; ?>">
                            <label class="col-sm-4 col-form-label">&nbsp; Item a Facturar</label>
                            <div class="col-sm-8">
                                <select class="custom-select custom-select-sm form-control form-control d-inp-light" name="producto_servicio_upC" id="producto_servicio_upC">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="custom-select custom-select-sm form-control form-control d-inp-light" name="precio_upC" id="precio_upC">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="custom-select custom-select-sm form-control form-control d-inp-light" name="mes_pagado_upC" id="mes_pagado_upC">
