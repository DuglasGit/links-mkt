...
<div class="card">
    <div class="card-header py-3 text-center">
        <h4 class="m-0 font-weight-bold text-danger">CLIENTES PPPOE SUSPENDIDOS</h4>
    </div>
    <div class="card-body">
                ...
                <tbody id="myTable">
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-inverse-danger btn-icon-text" data-toggle="modal" data-target="#modalDesactivarCliente">
                                <i class="mdi mdi-delete-sweep btn-icon-prepend"></i> Desactivar
                            </button>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select custom-select-sm form-control form-control border-primary text-light" id="inputGroupSelect01">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">ROL USUARIO</label>
                        <select class="custom-select custom-select-sm form-control form-control border-warning text-warning" id="inputGroupSelect01">
                            <option selected>Elegir...</option>
                            <option value="1">Administrador</option>
                            <option value="2">Oficina</option>
                            <option value="3">Técnico de Redes</option>
...
<div class="modal fade" id="modalDesactivarCliente" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog border border-danger rounded" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="modal-title text-danger" id="exampleModalLabel">Se Desactivará al usuario USUARIO</h3>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-inverse-warning" data-dismiss="modal">Cancelar</button>
