...
?>
    ...
    <div class="card">
        <div class="card-header py-3 text-center">
            <h4 class="m-0 font-weight-bold text-warning">CLIENTES PPPOE SUSPENDIDOS</h4>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <div class="form-group row justify-content-center">
                        <a href="<?php echo SERVERURL; ?>clientes-activos/" type="button" class="btn btn-inverse-primary btn-icon-text btn-fw">
                            <i class="mdi mdi-plus-circle-multiple-outline btn-icon-prepend"></i> VER CLIENTES ACTIVOS
                        </a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
